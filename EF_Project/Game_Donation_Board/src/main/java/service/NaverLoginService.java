...
public class NaverLoginService {
    ...
    private final static String CLIENT_ID = "TXFmtdFUoER8uvpoJOJm"; // 클라이언트 아이디
    private final static String CLIENT_SECRET = "ndAXdQIRXE"; // 클라이언트 시크릿
    private final static String REDIRECT_URI = "http://localhost:9090/board/callbackNaver.do";
